...
const Salvador = () => {
    ...
    const getCountry = async () => {
        try {
            const response = await fetch('https://api.covid19api.com/country/el-salvador?from=' + sevenDays + '&to=' + today);
    ...
    return (
        <View style={styles.container}>
            <Image source={require('../images/flags/salvador.png')} />
            <Text style={styles.title}> El Salvador</Text>
