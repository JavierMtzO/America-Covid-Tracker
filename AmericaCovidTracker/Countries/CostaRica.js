...
const CostaRica = () => {
    ...
    const getCountry = async () => {
        try {
            const response = await fetch('https://api.covid19api.com/country/costa-rica?from=' + sevenDays + '&to=' + today);
    ...
    return (
        <View style={styles.container}>
            <Image source={require('../images/flags/costarica.png')} />
            <Text style={styles.title}> Costa Rica</Text>
