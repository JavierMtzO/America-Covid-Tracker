...
const Nicaragua = () => {
    ...
    const getCountry = async () => {
        try {
            const response = await fetch('https://api.covid19api.com/country/nicaragua?from=' + sevenDays + '&to=' + today);
    ...
    return (
        <View style={styles.container}>
            <Image source={require('../images/flags/nicaragua.png')} />
            <Text style={styles.title}> Nicaragua</Text>
