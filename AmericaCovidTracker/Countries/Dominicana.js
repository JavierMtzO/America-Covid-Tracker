...
const Dominicana = () => {
    ...
    const getCountry = async () => {
        try {
            const response = await fetch('https://api.covid19api.com/country/dominican-republic?from=' + sevenDays + '&to=' + today);
    ...
    return (
        <View style={styles.container}>
            <Image source={require('../images/flags/dominicana.png')} />
            <Text style={styles.title}> República Dominicana</Text>
