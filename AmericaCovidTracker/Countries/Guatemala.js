...
const Guatemala = () => {
    ...
    const getCountry = async () => {
        try {
            const response = await fetch('https://api.covid19api.com/country/guatemala?from=' + sevenDays + '&to=' + today);
    ...
    return (
        <View style={styles.container}>
            <Image source={require('../images/flags/guatemala.png')} />
            <Text style={styles.title}> Guatemala</Text>
