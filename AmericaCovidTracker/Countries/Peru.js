...
const Peru = () => {
    ...
    const getCountry = async () => {
        try {
            const response = await fetch('https://api.covid19api.com/country/peru?from=' + sevenDays + '&to=' + today);
    ...
    return (
        <View style={styles.container}>
            <Image source={require('../images/flags/peru.png')} />
            <Text style={styles.title}> Perú </Text>
