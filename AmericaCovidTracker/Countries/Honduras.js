...
const Honduras = () => {
    ...
    const getCountry = async () => {
        try {
            const response = await fetch('https://api.covid19api.com/country/honduras?from=' + sevenDays + '&to=' + today);
    ...
    return (
        <View style={styles.container}>
            <Image source={require('../images/flags/honduras.png')} />
            <Text style={styles.title}> Honduras</Text>
